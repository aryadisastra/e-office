...
define("APP_ID", "3fff26c2a09bb8c59301fa75d86bb1aa");
...
define('USER_NAMA', (isset($_SESSION[APP_ID . 'user_data']) ? $_SESSION[APP_ID . 'user_data']['nama'] : null));
define('USER_EMAIL', (isset($_SESSION[APP_ID . 'user_data']) ? $_SESSION[APP_ID . 'user_data']['email'] : null));
define('USER_PARENT', (isset($_SESSION[APP_ID . 'user_data']) ? $_SESSION[APP_ID . 'user_data']['parent_id'] : null));

define('USER_ROLE', (isset($_SESSION[APP_ID . 'user_data']) ? $_SESSION[APP_ID . 'user_data']['role'] : null));
define('USER_BAGIAN', (isset($_SESSION[APP_ID . 'user_data']) ? $_SESSION[APP_ID . 'user_data']['bagian'] : null));
