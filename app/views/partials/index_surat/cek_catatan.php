...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">LOG CATATAN</h4>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <table class="table  table-striped table-sm text-left">
                                    <thead class="table-header bg-light">
                                        <tr>
                                            ...
                                            <th  class="td-pengguna"> Catatan</th>
                                            <th  class="td-pengguna"> Keterangan</th>
                                    ...
                                    <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-nomor_surat"> <?php if(isset($data['nomor_surat'])) echo $data['nomor_surat']; ?></td>
                                            <td class="td-pengguna"> <?php echo $data['pengguna']; ?></td>
                                            <td class="td-pengguna"> <?php echo $data['catatan']; ?></td>
                                            <td class="td-pengguna"> <?php echo $data['keterangan']; ?></td>
