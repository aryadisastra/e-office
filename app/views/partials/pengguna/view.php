                        ...
                        ?>
                            ...
                            <div class="p-3 d-flex">
                                ...
                                <?php if ($can_edit) { ?>
                                    ...
                                    <a class="btn btn-sm btn-success page-modal mx-1"  href="<?php print_link("pengguna/add_sign"); ?>?id=<?php echo $data['id']; ?>">
                                        <i class="fa fa-file"></i>
                                        Tanda Tangan
                                    </a>
                                <?php } ?>
                                <?php if ($can_delete) { ?>
                                    <a class="btn btn-sm btn-danger record-delete-btn mx-1" href="<?php print_link("pengguna/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Apakah anda yakin ingin menghapus?" data-display-style="modal">
