...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Distribusikan</h4>
                </div>
            </div>
        </div>
    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input id="ctrl-tanggal" class="form-control" value="<?php  echo $this->set_field_value('tanggal',datetime_now()); ?>" type="date" name="tanggal" placeholder="Tanggal"/> 
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8" >
                                                        <div class="" style="border-style: dashed; padding-left : 10px; border-color : #969590;">
                                                            <?php 
                                                                $kepada_options = $comp_model -> index_surat_kepada_kaur_option_list();
