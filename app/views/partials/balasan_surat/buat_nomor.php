            ...
            <div class="row ">
                <div class="col comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="balasan_surat-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("balasan_surat/buat_nomor?csrf_token=$csrf_token") ?>" method="post">
                            <div>
