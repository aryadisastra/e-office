...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Persetujuan Disposisi</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("persetujuan_disposisi/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-nomor_surat"  value="<?php  echo $data['nomor_surat']; ?>" type="text" placeholder="Nomor Surat"  readonly name="nomor_surat"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-pengguna"  value="<?php  echo $data['pengguna']; ?>" type="text" placeholder="Enter Pengguna"  readonly name="pengguna"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            ...
                                                            <label class="form-check form-check-inline option-btn">
                                                                <input id="ctrl-persetujuan" class="form-check-input" <?php echo $checked ?> value="<?php echo $value; ?>" type="radio"  name="persetujuan"   required="" />
