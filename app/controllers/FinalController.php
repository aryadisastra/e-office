 ...
 * @category  Controller
 */
class FinalController extends SecureController{
	...
	function index(){
		...
		$db = $this->GetModel();
		$pagination = null;
		$sqltext = "SELECT SQL_CALC_FOUND_ROWS  * FROM notnondis INNER JOIN dis_fil ON notnondis.nomor_surat=dis_fil.nomor_surat";
		$queryparams = null;
		...
		$page_title = $this->view->page_title = "Final";
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
		$this->view->report_orientation = "portrait";
		$this->render_view("final/list.php", $data); //render the full page
	}
}
